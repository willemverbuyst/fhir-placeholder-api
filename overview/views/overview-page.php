...
<body class="min-h-screen bg-slate-100 text-slate-900 antialiased">
    ...
    <script id="overview-dependency-data" type="application/json"><?php echo json_encode($dependencies, JSON_HEX_TAG | JSON_HEX_AMP | JSON_HEX_APOS | JSON_HEX_QUOT); ?></script>
